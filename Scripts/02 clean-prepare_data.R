...
#Current age of the woman
group1 <- c(23.8, 27.7, 23.5, 21.4, 32.0, 39.7, 28.6, 29.1, 14.3, 26.1, "*", 29.8, 27.7, 12.5, "*", 27.7, 13.0, 27.1, 30.6)
...
group6 <- c(54.2, 62.1, 54.3, 67.6, 57.4, 53.5, 68.3, 52.5, 56.0, "*", "*", 71.0, 59.9, "*", "*", 59.7, "*", 59.7, 65.5)
group7 <- c(55.0, 64.9, 55.3, 72.3, 52.5, 58.5, 80.2, 51.5, 52.6, "*", "*", 50.0, 62.5, "*", "*", 62.6, "*", 62.0, 64.8)
